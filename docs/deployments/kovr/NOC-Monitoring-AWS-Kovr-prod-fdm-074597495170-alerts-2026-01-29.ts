 ...
 * Customer: Kovr
 * Folder: NOC-Monitoring/AWS/Kovr-prod-fdm-074597495170
 * Generated: 2026-01-29T22:44:03.206Z
 * Alert Count: 26
 */
...
const ALERTS: Omit<AlertRuleConfig, 'folderUid'>[] = [
  ...
  {
    uid: "aurora-mqwezr-east2-cw-074",
    title: "Aurora-Alerts-Low-Storage (us-east-2)",
  ...
  {
    uid: "aurora-mqwezr-west2-cw-074",
  ...
  {
    uid: "aurora-d57n8w-east2-cw-074",
    title: "Aurora-Alerts-Connectivity-Loss (us-east-2)",
    ruleGroup: "RDS-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "aurora-d57n8w-west2-cw-074",
  ...
  {
    uid: "aurora-8cxrv2-east2-cw-074",
    title: "Aurora-Serverless-Alerts-ACU-High (us-east-2)",
    ruleGroup: "RDS-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
    ...
    annotations: {
          "summary": "High ACU utilization on Aurora Serverless {{ $labels.DBClusterIdentifier }}",
          "description": "Aurora Serverless cluster {{ $labels.DBClusterIdentifier }} ACU utilization is {{ $value }}% - may need to increase max ACU",
          "runbook_url": "https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2.setting-capacity.html"
    },
    data: [
          {
                "refId": "A",
  ...
  {
    uid: "aurora-8cxrv2-west2-cw-074",
    title: "Aurora-Serverless-Alerts-ACU-High (us-west-2)",
    ruleGroup: "RDS-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "aurora-qg1rzx-east2-cw-074",
    title: "Aurora-Alerts-Critical-CPU (us-east-2)",
    ruleGroup: "RDS-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "aurora-qg1rzx-west2-cw-074",
  ...
  {
    uid: "lambda-56l34n-east1-cw-074",
  ...
  {
    uid: "lambda-56l34n-east2-cw-074",
  ...
  {
    uid: "lambda-56l34n-west1-cw-074",
    title: "Lambda-Alerts-Critical-Errors (us-west-1)",
    ruleGroup: "LAMBDA-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "lambda-56l34n-west2-cw-074",
  ...
  {
    uid: "elasti-c0ltlw-east2-cw-074",
    title: "ElastiCache-Alerts-Connectivity-Loss (us-east-2)",
  ...
  {
    uid: "elasti-e6epkw-east2-cw-074",
    title: "ElastiCache-Alerts-Critical-Replication-Lag (us-east-2)",
    ruleGroup: "ELASTICACHE-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "elasti-vsb009-east2-cw-074",
    title: "ElastiCache-Alerts-Critical-CPU (us-east-2)",
    ruleGroup: "ELASTICACHE-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "elasti-mcfbay-east2-cw-074",
    title: "ElastiCache-Alerts-Critical-Memory-Usage (us-east-2)",
    ruleGroup: "ELASTICACHE-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
...
async function provisionAlerts(config: GrafanaConfig): Promise<ProvisioningResult> {
  ...
  const folder = await client.ensureFolder('NOC-Monitoring/AWS/Kovr-prod-fdm-074597495170');
...
async function main(): Promise<void> {
  ...
  if (isDeleteMode) {
    ...
    console.log(`   Customer: Kovr`);
    console.log(`   Folder: NOC-Monitoring/AWS/Kovr-prod-fdm-074597495170`);

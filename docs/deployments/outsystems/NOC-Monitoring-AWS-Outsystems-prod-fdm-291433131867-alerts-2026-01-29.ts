 ...
 * Customer: Outsystems
 * Folder: NOC-Monitoring/AWS/Outsystems-prod-fdm-291433131867
 * Generated: 2026-01-29T22:52:34.671Z
 * Alert Count: 12
 */
...
const ALERTS: Omit<AlertRuleConfig, 'folderUid'>[] = [
  ...
  {
    uid: "lambda-56l34n-east1-cw-291",
...
async function provisionAlerts(config: GrafanaConfig): Promise<ProvisioningResult> {
  ...
  const folder = await client.ensureFolder('NOC-Monitoring/AWS/Outsystems-prod-fdm-291433131867');
...
async function main(): Promise<void> {
  ...
  if (isDeleteMode) {
    ...
    console.log(`   Customer: Outsystems`);
    console.log(`   Folder: NOC-Monitoring/AWS/Outsystems-prod-fdm-291433131867`);

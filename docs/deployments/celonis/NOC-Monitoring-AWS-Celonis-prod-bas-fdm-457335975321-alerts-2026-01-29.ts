 ...
 * Customer: Celonis
 * Folder: NOC-Monitoring/AWS/Celonis-prod-bas-fdm-457335975321
 * Generated: 2026-01-29T22:32:15.229Z
 * Alert Count: 16
 */
...
const ALERTS: Omit<AlertRuleConfig, 'folderUid'>[] = [
  ...
  {
    uid: "rds-5mdtgn-east1-cw-457",
    title: "RDS-Alerts-Critical-Replica-Lag (us-east-1)",
    ruleGroup: "RDS-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "lambda-56l34n-east1-cw-457",
  ...
  {
    uid: "lambda-56l34n-east2-cw-457",
  ...
  {
    uid: "lambda-56l34n-west1-cw-457",
...
async function provisionAlerts(config: GrafanaConfig): Promise<ProvisioningResult> {
  ...
  const folder = await client.ensureFolder('NOC-Monitoring/AWS/Celonis-prod-bas-fdm-457335975321');
...
async function main(): Promise<void> {
  ...
  if (isDeleteMode) {
    ...
    console.log(`   Customer: Celonis`);
    console.log(`   Folder: NOC-Monitoring/AWS/Celonis-prod-bas-fdm-457335975321`);

 ...
 * Folder: NOC-Monitoring/AWS/CoSo-prod-global-fdm-914798737783
 * Generated: 2026-01-29T23:24:38.346Z
 * Alert Count: 12
 */
...
const ALERTS: Omit<AlertRuleConfig, 'folderUid'>[] = [
  ...
  {
    uid: "aurora-mqwezr-east1-cw-914",
  ...
  {
    uid: "aurora-d57n8w-east1-cw-914",
  ...
  {
    uid: "aurora-qg1rzx-east1-cw-914",
  ...
  {
    uid: "lambda-56l34n-east1-cw-914",
  ...
  {
    uid: "apigat-o9g066-east1-cw-914",
...
async function provisionAlerts(config: GrafanaConfig): Promise<ProvisioningResult> {
  ...
  const folder = await client.ensureFolder('NOC-Monitoring/AWS/CoSo-prod-global-fdm-914798737783');
...
async function main(): Promise<void> {
  ...
  if (isDeleteMode) {
    ...
    console.log(`   Customer: CoSo-prod-global-fdm`);
    console.log(`   Folder: NOC-Monitoring/AWS/CoSo-prod-global-fdm-914798737783`);

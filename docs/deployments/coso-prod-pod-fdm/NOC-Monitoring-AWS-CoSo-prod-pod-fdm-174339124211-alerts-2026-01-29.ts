 ...
 * Folder: NOC-Monitoring/AWS/CoSo-prod-pod-fdm-174339124211
 * Generated: 2026-01-29T23:28:02.193Z
 * Alert Count: 19
 */
...
const ALERTS: Omit<AlertRuleConfig, 'folderUid'>[] = [
  ...
  {
    uid: "aurora-mqwezr-east1-cw-174",
    title: "Aurora-Alerts-Low-Storage (us-east-1)",
  ...
  {
    uid: "aurora-d57n8w-east1-cw-174",
    title: "Aurora-Alerts-Connectivity-Loss (us-east-1)",
    ruleGroup: "RDS-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "aurora-qg1rzx-east1-cw-174",
    title: "Aurora-Alerts-Critical-CPU (us-east-1)",
    ruleGroup: "RDS-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "lambda-56l34n-east1-cw-174",
  ...
  {
    uid: "lambda-56l34n-east2-cw-174",
  ...
  {
    uid: "elasti-c0ltlw-east1-cw-174",
  ...
  {
    uid: "elasti-e6epkw-east1-cw-174",
  ...
  {
    uid: "elasti-vsb009-east1-cw-174",
  ...
  {
    uid: "elasti-mcfbay-east1-cw-174",
  ...
  {
    uid: "apigat-o9g066-east1-cw-174",
    title: "APIGateway-Alerts-Critical-5xx-Errors (us-east-1)",
    ruleGroup: "APIGATEWAY-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
    for: "5m",
...
async function provisionAlerts(config: GrafanaConfig): Promise<ProvisioningResult> {
  ...
  const folder = await client.ensureFolder('NOC-Monitoring/AWS/CoSo-prod-pod-fdm-174339124211');
...
async function main(): Promise<void> {
  ...
  if (isDeleteMode) {
    ...
    console.log(`   Customer: CoSo-prod-pod-fdm`);
    console.log(`   Folder: NOC-Monitoring/AWS/CoSo-prod-pod-fdm-174339124211`);

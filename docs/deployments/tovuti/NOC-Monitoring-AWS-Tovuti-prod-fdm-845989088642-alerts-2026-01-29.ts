 ...
 * Customer: Tovuti
 * Folder: NOC-Monitoring/AWS/Tovuti-prod-fdm-845989088642
 * Generated: 2026-01-29T22:56:07.175Z
 * Alert Count: 21
 */
...
const ALERTS: Omit<AlertRuleConfig, 'folderUid'>[] = [
  ...
  {
    uid: "aurora-mqwezr-west2-cw-845",
  ...
  {
    uid: "aurora-d57n8w-west2-cw-845",
  ...
  {
    uid: "aurora-qg1rzx-west2-cw-845",
  ...
  {
    uid: "lambda-56l34n-east1-cw-845",
  ...
  {
    uid: "lambda-56l34n-west2-cw-845",
  ...
  {
    uid: "elasti-c0ltlw-west2-cw-845",
  ...
  {
    uid: "elasti-e6epkw-west2-cw-845",
  ...
  {
    uid: "elasti-vsb009-west2-cw-845",
  ...
  {
    uid: "elasti-mcfbay-west2-cw-845",
  ...
  {
    uid: "nlb-fcf2t1-west2-cw-845",
    title: "NLB-Alerts-Unhealthy-Hosts (us-west-2)",
  ...
  {
    uid: "nlb-wueh4s-west2-cw-845",
    title: "NLB-Alerts-No-Healthy-Hosts (us-west-2)",
    ruleGroup: "NLB-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
...
async function provisionAlerts(config: GrafanaConfig): Promise<ProvisioningResult> {
  ...
  const folder = await client.ensureFolder('NOC-Monitoring/AWS/Tovuti-prod-fdm-845989088642');
...
async function main(): Promise<void> {
  ...
  if (isDeleteMode) {
    ...
    console.log(`   Customer: Tovuti`);
    console.log(`   Folder: NOC-Monitoring/AWS/Tovuti-prod-fdm-845989088642`);

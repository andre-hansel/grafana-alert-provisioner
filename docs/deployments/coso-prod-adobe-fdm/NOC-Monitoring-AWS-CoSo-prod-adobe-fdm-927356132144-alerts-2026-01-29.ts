 ...
 * Folder: NOC-Monitoring/AWS/CoSo-prod-adobe-fdm-927356132144
 * Generated: 2026-01-29T23:19:07.775Z
 * Alert Count: 20
 */
...
const ALERTS: Omit<AlertRuleConfig, 'folderUid'>[] = [
  ...
  {
    uid: "lambda-56l34n-east1-cw-927",
  ...
  {
    uid: "elasti-c0ltlw-east1-cw-927",
  ...
  {
    uid: "elasti-e6epkw-east1-cw-927",
    title: "ElastiCache-Alerts-Critical-Replication-Lag (us-east-1)",
    ruleGroup: "ELASTICACHE-Alerts",
    condition: 'C',
    noDataState: 'OK',
    execErrState: 'Error',
  ...
  {
    uid: "elasti-vsb009-east1-cw-927",
  ...
  {
    uid: "elasti-mcfbay-east1-cw-927",
...
async function provisionAlerts(config: GrafanaConfig): Promise<ProvisioningResult> {
  ...
  const folder = await client.ensureFolder('NOC-Monitoring/AWS/CoSo-prod-adobe-fdm-927356132144');
...
async function main(): Promise<void> {
  ...
  if (isDeleteMode) {
    ...
    console.log(`   Customer: CoSo-prod-adobe-fdm`);
    console.log(`   Folder: NOC-Monitoring/AWS/CoSo-prod-adobe-fdm-927356132144`);

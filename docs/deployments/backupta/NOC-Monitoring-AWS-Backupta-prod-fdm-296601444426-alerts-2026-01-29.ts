 ...
 * Customer: Backupta
 * Folder: NOC-Monitoring/AWS/Backupta-prod-fdm-296601444426
 * Generated: 2026-01-29T22:16:44.506Z
 * Alert Count: 9
 */
...
const ALERTS: Omit<AlertRuleConfig, 'folderUid'>[] = [
  ...
  {
    uid: "lambda-56l34n-east1-cw-296",
  ...
  {
    uid: "apigat-o9g066-east1-cw-296",
...
async function provisionAlerts(config: GrafanaConfig): Promise<ProvisioningResult> {
  ...
  const folder = await client.ensureFolder('NOC-Monitoring/AWS/Backupta-prod-fdm-296601444426');
...
async function main(): Promise<void> {
  ...
  if (isDeleteMode) {
    ...
    console.log(`   Customer: Backupta`);
    console.log(`   Folder: NOC-Monitoring/AWS/Backupta-prod-fdm-296601444426`);
